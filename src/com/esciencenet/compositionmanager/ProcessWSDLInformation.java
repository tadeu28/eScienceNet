...
import com.esciencenet.servicemanager.wsdlmodels.WSDLRecoverBinding;
...
import com.esciencenet.servicemanager.wsdlmodels.WSDLRecoverPortType;
...
public class ProcessWSDLInformation {
    ...
    public WSDLRecover getWSDLInfo(String wsdlURL, String operationName, List<String> in, List<String> out){
        try{
            ...
            JOptionPane.showMessageDialog(null, "It wasn't possible to get service information.\n\n" + e, ".: e-ScienceNet :.", JOptionPane.ERROR_MESSAGE);
            return null;
        }
    }
    ...
    private WSDLRecover recuperarServico(String wsdlURL, String operacaoNome, List<String> inputs, List<String> outputs){
        try{
            ...
            JOptionPane.showMessageDialog(null, this.error, ".: e-ScienceNet :.", JOptionPane.ERROR_MESSAGE);
            return null;
        }
    }
    ...
    private Document soapResponseProcess(SOAPMessage soapResponse) throws Exception {
        ...
        File file = SemanticManager.getInstance().getDataManager().createATempFile();
